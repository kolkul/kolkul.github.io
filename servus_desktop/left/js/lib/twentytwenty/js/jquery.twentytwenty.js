(function($){
	...
	$.fn.twentytwenty = function(options) {
		...
		return this.each(function() {
			...
			container.on('twentytwenty_move', function(e, pos) {
				pos=parseInt(pos);
				if (!isNaN(pos)) {
					sliderPct=getSliderPercentage(pos, pos);
			...
			var getSliderPercentage = function(positionX, positionY) {
				...
				return sliderPercentage; //minMaxNumber(sliderPercentage, 0, 1);
			};
